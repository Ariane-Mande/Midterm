...
<html lang="en">
<head>
    <title>Lab Activity 3 - Authenticator</title>
    <meta charset="UTF-8">
    ...
    <body style="background-color:#00a31c;">
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="hh" class="modal-title">VERIFICATION CODE</h4>
                          <form role="form" method="post"><br>
                    <div class="form-group">
                    <input type="text" id="hhh" name="code" class="form-control" placeholder="Enter the verification code" maxlength="6"    >    
                   
                </div>
                <div class="form-group">
                   <center> <center><button type="submit" id="btn1" name="login" class="btn">SUBMIT</button><BR></center>
                </div>
                  </div>
